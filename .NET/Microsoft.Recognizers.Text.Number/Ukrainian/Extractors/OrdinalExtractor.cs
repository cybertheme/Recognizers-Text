...
namespace Microsoft.Recognizers.Text.Number.Ukrainian
{
    public class OrdinalExtractor : BaseNumberExtractor
    {
        public const string RoundNumberOrdinalRegex =
            @"(тисячний|тисячна|тисячні|тисячного|тисячних|тисячну|тисячному|тисячній|тисячним|тисячною|тисячними|мільйонний|мільйонна|мільйонні|мільйонного|мільйонних|мільйонну|мільйонному|мільйонній|мільйонним|мільйонною|мільйонними|мільярдний|мільярдна|мільярдні|мільярдного|мільярдних|мільярдну|мільярдному|мільярдній|мільярдним|мільярдною|мільярдними|трильйонний|трильйонна|трильйонні|трильйонного|трильйонних|трильйонну|трильйонному|трильйонній|трильйонним|трильйонною|трильйонними)";
        ...
        public OrdinalExtractor(NumberOptions options)
            : base(options)
        {
